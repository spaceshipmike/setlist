...
const api = {
  ...
  searchProjects: (opts) => window.setlist.searchProjects(opts),
  ...
  listProjectPorts: (projectName) => window.setlist.listProjectPorts(projectName),
  queryCapabilities: (opts) => window.setlist.queryCapabilities(opts),
  recallMemories: (opts) => window.setlist.recallMemories(opts),
...
function StatusFilterMenu({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Root2$1, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Portal2, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Content2,
      {
        ...
        children: [
          statuses.map((status) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            CheckboxItem2,
            {
              ...
              children: [
                ...
                ${selected.includes(status) ? "bg-[var(--color-accent)] border-[var(--color-accent)]" : "border-[var(--color-border-strong)]"}`,
          ...
          selected.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Separator2, { className: "h-px my-1 bg-[var(--color-border)]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Item2,
              {
                onSelect: () => onChange([]),
...
function HomeView({
  ...
  if (loading && projects.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--color-text-tertiary)]", children: "Loading projects..." }) });
  }
  if (error) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--color-error)]", children: error }) });
  }
  if (projects.length === 0 && !filter && statusFilters.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { onRegister });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold text-[var(--color-text-primary)]", children: "Projects" }),
  ...
  const refresh = reactExports.useCallback(async () => {
    try {
      ...
      const [proj, caps, pts, mem] = await Promise.all([
        ...
        api.recallMemories({ project: name, token_budget: 8e3 })
      ]);
      setProject(proj);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-semibold text-[var(--color-text-primary)] truncate", children: displayName }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shrink-0 text-xs px-1.5 py-0.5 rounded bg-[var(--color-accent-muted)] text-[var(--color-accent)]", children: typeLabel }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `shrink-0 inline-flex items-center gap-1.5 text-xs text-[var(--color-text-tertiary)]`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `w-1.5 h-1.5 rounded-full ${status === "active" ? "bg-[var(--color-success)]" : status === "paused" ? "bg-[var(--color-warning)]" : "bg-[var(--color-text-tertiary)]"}` }),
            status
          ] })
        ] }),
        name !== displayName && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-[var(--color-text-tertiary)] font-mono mb-1", children: name }),
        description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[var(--color-text-secondary)] mt-1", children: description })
      ] }),
...
function OverviewTab({ project, onNavigate }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    topics.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Topics", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: topics.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { label: t }, t)) }) }),
    entities.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Entities", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: entities.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { label: e, accent: true }, e)) }) }),
    concerns.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Active Concerns", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: concerns.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { label: c, warning: true }, c)) }) }),
    project.paths && project.paths.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Paths", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: project.paths.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-mono text-[var(--color-text-secondary)]", children: p }, p)) }) }),
    Object.keys(fields).length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Fields", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: Object.entries(fields).map(([key, value]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--color-text-tertiary)] min-w-[120px] shrink-0", children: key }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--color-text-secondary)]", children: typeof value === "string" ? value : JSON.stringify(value) })
    ] }, key)) }) })
  ] });
}
...
function Tag({ label, accent, warning }) {
  const color = warning ? "text-[var(--color-warning)] bg-[var(--color-warning)]/10" : accent ? "text-[var(--color-accent)] bg-[var(--color-accent-muted)]" : "text-[var(--color-text-secondary)] bg-[var(--color-bg-elevated)]";
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs px-2 py-0.5 rounded ${color} border border-[var(--color-border)]`, children: label });
}
const TYPE_COLORS = {
...
function MemoryTab({ memories }) {
  if (memories.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-12 text-[var(--color-text-tertiary)]", children: "No memories for this project" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: memories.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[var(--color-text-tertiary)] ml-auto", children: new Date(m.created_at).toLocaleDateString() })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[var(--color-text-secondary)] line-clamp-3", children: m.content })
      ]
    },
    m.id
  )) });
}
function CapabilitiesTab({ capabilities }) {
  if (capabilities.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-12 text-[var(--color-text-tertiary)]", children: "No capabilities declared" });
  }
  const grouped = {};
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: Object.entries(grouped).map(([type, caps]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-xs font-medium uppercase tracking-wider text-[var(--color-text-tertiary)] mb-2", children: [
      type,
      " (",
      caps.length,
      ")"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: caps.map((cap) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "p-3 rounded-lg bg-[var(--color-bg-elevated)] border border-[var(--color-border)]",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-sm text-[var(--color-text-primary)]", children: cap.name }),
            cap.requires_auth && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs px-1.5 py-0.5 rounded bg-[var(--color-warning)] text-[var(--color-bg)]", children: "auth" })
          ] }),
          cap.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-[var(--color-text-secondary)]", children: cap.description })
        ]
      },
      cap.name
    )) })
...
function PortsTab({ ports }) {
  if (ports.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-12 text-[var(--color-text-tertiary)]", children: "No ports allocated" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "text-left text-xs text-[var(--color-text-tertiary)] uppercase tracking-wider", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "pb-2 pr-4", children: "Port" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "pb-2 pr-4", children: "Service" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "pb-2 pr-4", children: "Protocol" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: ports.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t border-[var(--color-border)]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 pr-4 font-mono text-[var(--color-accent)]", children: p.port }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 pr-4 text-[var(--color-text-secondary)]", children: p.service_label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 pr-4 text-[var(--color-text-tertiary)]", children: p.protocol })
    ] }, p.port)) })
  ] });
}
...
function EditProjectForm({ name, currentValues: currentValues2, onSave, onCancel }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 p-4 rounded-lg bg-[var(--color-bg-card)] border border-[var(--color-border-accent)]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-sm font-medium text-[var(--color-text-primary)]", children: [
        "Editing ",
        name
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[var(--color-text-tertiary)] mb-1 block", children: "Display name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[var(--color-text-tertiary)] mb-1 block", children: "Status" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            value: status,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[var(--color-text-tertiary)] mb-1 block", children: "Description" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "textarea",
        {
          value: description,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[var(--color-text-tertiary)] mb-1 block", children: "Goals (comma-separated)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "text",
...
function ArchiveConfirmDialog({ open, onOpenChange, projectName, onSuccess }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Root, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Portal, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Overlay, { className: "fixed inset-0 bg-black/80" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Content, { className: "fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2\n          w-full max-w-sm p-6 rounded-xl\n          bg-[var(--color-bg-elevated)] border border-[var(--color-border)]\n          shadow-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Title, { className: "text-lg font-semibold text-[var(--color-text-primary)] mb-2", children: [
        "Archive ",
        projectName,
        "?"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Description, { className: "text-sm text-[var(--color-text-secondary)] mb-6", children: "This will set the project to archived status, release all ports, and clear capabilities. The project data is preserved and can be restored." }),
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-[var(--color-error)] bg-[var(--color-bg-card)] rounded-md p-2 mb-4", children: error }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Close, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-4 py-2 rounded-md text-sm text-[var(--color-text-secondary)]\n                hover:bg-[var(--color-bg-card)] transition-colors", children: "Cancel" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
...
function RenameDialog({ open, onOpenChange, currentName, onSuccess }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Root, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Portal, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Overlay, { className: "fixed inset-0 bg-black/80" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Content, { className: "fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2\n          w-full max-w-sm p-6 rounded-xl\n          bg-[var(--color-bg-elevated)] border border-[var(--color-border)]\n          shadow-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { className: "text-lg font-semibold text-[var(--color-text-primary)] mb-4", children: "Rename project" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleRename, className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[var(--color-text-tertiary)] mb-1 block", children: "New name" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
...
function ProjectDetailView({ projectName, onBack, onNavigate }) {
  ...
  const [showRename, setShowRename] = reactExports.useState(false);
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--color-text-tertiary)]", children: "Loading..." }) });
  }
  if (error || !project) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[var(--color-error)]", children: error || "Project not found" })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    editing && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      EditProjectForm,
      {
        name: project.name,
        currentValues: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Root2, { defaultValue: "overview", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(List, { className: "flex gap-1 border-b border-[var(--color-border)] mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabTrigger, { value: "overview", children: "Overview" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabTrigger, { value: "memory", children: [
          "Memory ",
          memories.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Count, { n: memories.length })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabTrigger, { value: "capabilities", children: [
          "Capabilities ",
          capabilities.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Count, { n: capabilities.length })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabTrigger, { value: "ports", children: [
          "Ports ",
...
function PathField({ label, description, value, onChange, saving }) {
  ...
  if (!editing) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-3 border-b border-[var(--color-border)]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium text-[var(--color-text-primary)]", children: label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[var(--color-text-tertiary)] mt-0.5", children: description }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-mono text-[var(--color-text-secondary)] mt-1", children: value || /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-[var(--color-text-tertiary)]", children: "Not configured" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: value ? "Change" : "Set"
        }
      )
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-3 border-b border-[var(--color-border)]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium text-[var(--color-text-primary)] mb-1", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[var(--color-text-tertiary)] mb-2", children: description }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
...
function SettingsView({ onBack }) {
  ...
  const save = async (opts) => {
    ...
    try {
      ...
      setConfig(updated);
      setSuccess("Saved");
      setTimeout(() => setSuccess(null), 2e3);
    } catch (e) {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--color-text-tertiary)]", children: "Loading settings..." }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold text-[var(--color-text-primary)] mb-1", children: "Settings" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[var(--color-text-tertiary)] mb-6", children: "Configure where projects are created and archived on disk." }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-[var(--color-error)] bg-[var(--color-bg-card)] rounded-md p-2 mb-4", children: error }),
    success && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-[var(--color-success)] bg-[var(--color-bg-card)] rounded-md p-2 mb-4", children: success }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        PathField,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
        ...
        hasBootstrapConfig && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-[var(--color-border)] pt-4 space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 cursor-pointer", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-[var(--color-text-primary)]", children: "Create folder on disk" })
          ] }),
          createFolder && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pl-5 space-y-3", children: [
            resolvedPath ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-mono text-[var(--color-text-tertiary)] bg-[var(--color-bg-card)] rounded px-2 py-1.5", children: resolvedPath }) : !pathRoot ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-[var(--color-warning)]", children: "No path root configured for this type. Set it in Settings." }) : null,
            config?.template_dir && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-[var(--color-text-tertiary)]", children: [
              "Templates from ",
              config.template_dir
            ] }),
            type === "code_project" && /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 cursor-pointer", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[var(--color-text-secondary)]", children: "Skip git init" })
            ] })
          ] })
        ] }),
        error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-[var(--color-error)] bg-[var(--color-bg-card)] rounded-md p-2", children: error }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2 pt-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: "px-4 py-2 rounded-md text-sm font-medium\n                  bg-[var(--color-accent)] text-white\n                  hover:bg-[var(--color-accent-hover)]\n                  disabled:opacity-50 transition-colors",
              children: saving ? createFolder ? "Creating..." : "Registering..." : createFolder ? "Create" : "Register"
            }
          )
        ] })
      ] })
...
function Field({ label, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "block", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-[var(--color-text-tertiary)] mb-1 block", children: label }),
    children
  ] });
}
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "titlebar-drag h-8 shrink-0" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 overflow-auto px-6 pb-6", children: view.kind === "home" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      HomeView,
      {
    ...
    ) : view.kind === "settings" ? /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsView, { onBack: navigateHome }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
      ProjectDetailView,
      {
